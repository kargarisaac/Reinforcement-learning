...
class GameState:
    def __init__(self):
        ...
        self.obstacles.append(self.create_obstacle(450, 400, 80))
        self.obstacles.append(self.create_obstacle(800, 250, 80))
        self.obstacles.append(self.create_obstacle(700, 500, 80))
        self.obstacles.append(self.create_obstacle(200, 200, 80))
        self.obstacles.append(self.create_obstacle(200, 500, 80))
